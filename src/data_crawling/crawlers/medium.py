...
from src.core.db.documents import ArticleDocument, UserDocument  # Assuming PostDocument might be needed, though ArticleDocument is used
...
class MediumCrawler(BaseAbstractCrawler):
    ...
    async def extract(self, link: str, db_client: SupabaseClient, user_info: Optional[dict] = None) -> None:
        ...
        # --- Save Document ---
        await self.save_documents([document_instance], db_client=db_client)
