...
class UserDocument(BaseModel):
    ...
    async def get_or_create(cls: Type['UserDocument'], defaults: typing.Optional[dict] = None, **kwargs) -> 'UserDocument':
        ...
        existing_user = await cls.find_one(**kwargs)
        ...
        try:
            # Pydantic will validate required fields (first_name, last_name) during instantiation
            ...
            error_msg = f"Failed to instantiate UserDocument. Check required fields (first_name, last_name). Data: {create_data}, Error: {e}"
